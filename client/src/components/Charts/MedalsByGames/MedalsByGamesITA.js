...
function MedalsByGamesITA({ data }) {
  const ref = useD3(
    (svg) => {
  ...
  return (
    <div>
      <p className={styles.countryMedalCount}>
        <span className={styles.countryName}>Italy</span> 542 medals since 1976
      </p>
...
export default MedalsByGamesITA;
