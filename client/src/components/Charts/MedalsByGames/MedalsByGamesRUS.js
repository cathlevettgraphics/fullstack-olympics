...
function MedalsByGamesRUS({ data }) {
  const ref = useD3(
    (svg) => {
  ...
  return (
    <div>
      <p className={styles.countryMedalCount}>
        <span className={styles.countryName}>Russia</span> 2,341 medals since
        1976
      </p>
...
export default MedalsByGamesRUS;
